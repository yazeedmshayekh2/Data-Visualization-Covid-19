...
ui_mainBody <- function(id, ProportionShow = TRUE) {
  ...
  tagList(
    ...
    box(
      title = "Confirmed", width = 12, status = "warning", solidHeader = TRUE,
      column(
        width = 6,
    ...
    # Death barcharts
    box(
      title = "Death", width = 12, status = "warning", solidHeader = TRUE,
      column(
        width = 6,
    ...
    if (ProportionShow) {
      box(
        title = "Recovered", width = 12, status = "warning", solidHeader = TRUE,
        column(
          width = 6,
