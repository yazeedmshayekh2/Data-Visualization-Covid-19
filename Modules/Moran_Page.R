  ...
  tagList(
    ...
    tabsetPanel(
      tabPanel(
        "Charts",
        box(
          title = "The p-value of Moran's test", width = 12, status = "warning", solidHeader = TRUE,
          withSpinner(plotlyOutput(ns("plt1")))
        ),
        box(
          title = "Difference of observed and expected values of Moran's Index", width = 12, status = "warning", solidHeader = TRUE,
