...
source("Modules/dist_countries.R")
source("Modules/timeSeriesPlotPage.R")
source("Modules/timeSeriesPlots.R")

ui <- dashboardPage(
  title = "COVID-19 Dashboard",
  dashboardHeader(titleWidth = 220, title = span(img(src = "Corona2.png", width = 12)), disable = FALSE),
  {
    ## Sidebar  #----
    dashboardSidebar(
      width = 220,
    ...
    tabItems(
      ...
      tabItem(
        ...
        fluidRow(
          ...
          column(
            width = 5,
            img(src = "University_of_Jordan_Logo.png", height = "260px", width = "220px")
          )
        )
      ),
      tabItem(
        ...
        HTML("<div style = 'font-size: 14.5px;color:black;font-weight:bold'>  <a style = 'font-size: 16px;color:blue;font-weight:bold'; href = https://github.com/yazeedmshayekh2> Yazeed Mshayekh </a>: Department of Artificial Intelligence, University of Jordan, Jordan</div>"),
        br(),
        HTML("<div style = 'font-size: 14.5px;color:black;font-weight:bold'>  <a style = 'font-size: 16px;color:blue;font-weight:bold'> Khaled Rabee</a>: Department of Artificial Intelligence, University of Jordan, Jordan </div>"),
        br(),
        HTML("<div style = 'font-size: 14.5px;color:black;font-weight:bold'>  <a style = 'font-size: 16px;color:blue;font-weight:bold'> Adel Kayyali</a>: Department of Artificial Intelligence, University of Jordan, Jordan </div>"),
        br(),
        HTML("<div style = 'font-size: 14.5px;color:black;font-weight:bold'>  <a style = 'font-size: 16px;color:blue;font-weight:bold'> Basil Darwazeh </a>: Department of Artificial Intelligence, University of Jordan, Jordan </div>"),
        br()
      ),
      tabItem(
        tabName = "table",
